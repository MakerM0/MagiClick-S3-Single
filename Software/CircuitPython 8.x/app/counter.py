...
def getCount():
    return (alarm.sleep_memory[4] | (alarm.sleep_memory[5]<<8) | (alarm.sleep_memory[6]<<16) | (alarm.sleep_memory[7]<<24))

def setCount(cnt):
    alarm.sleep_memory[4] = cnt&0xff
    alarm.sleep_memory[5] = cnt>>8
    alarm.sleep_memory[6] = cnt>>16
    alarm.sleep_memory[7] = cnt>>24
