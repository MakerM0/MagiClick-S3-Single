...
WEATHERKEY = os.getenv("WEATHER_KEY_CN")
if WEATHERKEY =="":    
    WEATHERKEY = 'ctpe2272nswh94og'
    
LOCATION = os.getenv("LOCATION_CN")
if LOCATION=="":
    LOCATION = 'sanya'
...
DATA_SOURCE = (
    "http://api.seniverse.com/v3/weather/now.json?key="    + WEATHERKEY    + "&location="    + LOCATION    + "&language="    + LANGUAGE    + "&unit="    + UNITS 
)
